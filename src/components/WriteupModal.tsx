...
const WriteupModal = ({ machine, onClose }: WriteupModalProps) => {
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="bg-card-bg border-2 border-cyber-green rounded-lg max-w-4xl w-full h-full max-h-[90vh] mx-auto flex flex-col shadow-2xl">
        ...
        <div className="prose prose-invert prose-lg p-8 overflow-y-auto flex-grow bg-card-bg text-gray-200
