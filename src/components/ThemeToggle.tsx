...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      {theme === "dark" ? (
        <FaSun className="h-5 w-5 text-cyber-green hover:text-cyber-blue transition-colors duration-300" />
      ) : (
        <FaMoon className="h-5 w-5 text-cyber-green hover:text-cyber-blue transition-colors duration-300" />
      )}
    </button>
  );
}
