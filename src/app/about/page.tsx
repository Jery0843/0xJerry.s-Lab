...
const About = () => {
  return (
    <Layout>
            <div className="bg-gray-100/90 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 rounded-lg p-6 lg:p-8 backdrop-blur-sm">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-1 flex flex-col items-center">
              <div className="relative w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full border-2 border-green-600 dark:border-cyber-green mb-4 sm:mb-6 overflow-hidden group animate-pulse hover:animate-none transition-all duration-300">
                ...
                {/* Image container */}
                <div className="relative w-full h-full rounded-full border-2 border-green-600 dark:border-cyber-green bg-black overflow-hidden transform transition-all duration-300 group-hover:scale-105 group-hover:rotate-1">
                  <img 
            ...
            <div className="lg:col-span-2 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-cyber-green/30 p-4 sm:p-6 lg:p-8 rounded-lg shadow-sm">
          ...
          <div className="mt-12 sm:mt-14 lg:mt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 text-center">
              {['Python', 'Bash', 'PowerShell', 'React', 'Reverse Engineering', 'Web Exploitation', 'Active Directory', 'Metasploit'].map(skill => (
                <div key={skill} className="bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-cyber-green/30 p-3 sm:p-4 rounded-lg hover:border-blue-500 dark:hover:border-cyber-blue transition-all duration-300 hover:transform hover:scale-105 shadow-sm">
