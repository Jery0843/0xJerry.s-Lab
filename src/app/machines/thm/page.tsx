    ...
    <Layout>
      <div className="py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
          <div className="bg-card-bg border border-cyber-purple/30 p-4 rounded-lg text-center">
        ...
        {/* Filters */}
        <div className="bg-card-bg border border-cyber-purple/30 p-6 rounded-lg mb-8">
        ...
        {showAddModal && (
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
            <div className="bg-card-bg border border-cyber-purple rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
