...
export default function MachinePage({ machine, initialRelatedMachines }: MachinePageProps) {
  ...
  if (isActiveGate) {
    return <ActiveMachine403 machineName={machine.name} summary={machine.summary || null} />;
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            <div className="sticky top-24 space-y-6">
              {/* System Vitals */}
              <div className="bg-card-bg/80 backdrop-blur-sm border border-cyber-green/20 rounded-lg p-4" style={{ animation: 'panelLoad 0.6s ease-out forwards' }}>
              ...
              {/* Tags */}
              <div className="bg-card-bg/80 backdrop-blur-sm border border-cyber-purple/20 rounded-lg p-4" style={{ animation: 'panelLoad 0.8s ease-out forwards' }}>
          ...
          >
            <div className="sticky top-24">
              ...
              {/* Similar Machines */}
              <div className="bg-card-bg/80 backdrop-blur-sm border border-cyber-blue/20 rounded-lg p-4 mt-6" style={{ animation: 'panelLoad 1.2s ease-out forwards' }}>
