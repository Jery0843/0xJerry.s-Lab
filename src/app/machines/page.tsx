      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-12 px-2 sm:px-4">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-cyber font-bold mb-3 sm:mb-4">
            <span className="text-cyber-green" data-text="MACHINE LABS">
              MACHINE LABS
            </span>
          </h1>
          <div className="flex justify-center">
            <p className="text-base sm:text-lg lg:text-xl text-center text-gray-400 dark:text-gray-400 light:text-gray-600 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
          ...
          <div className="relative group">
            ...
            {editingHTB ? (
              // HTB Edit Mode
              <div className="bg-card-bg border border-cyber-green rounded-lg p-4 sm:p-6 lg:p-8">
              ...
              <Link href="/machines/htb" className="block group">
                <div className="bg-card-bg border border-cyber-green/30 rounded-lg p-4 sm:p-6 lg:p-8 hover:border-cyber-green hover:bg-cyber-green/5 transition-all duration-300 hover:shadow-lg hover:shadow-cyber-green/30 hover:scale-[1.02]">
                  <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div className="bg-terminal-bg/50 dark:bg-terminal-bg/50 light:bg-gray-50 rounded-lg p-3 sm:p-4">
                  ...
                  <div className="text-center">
                    <span className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-cyber-green/10 dark:bg-cyber-green/10 light:bg-green-50 border border-cyber-green dark:border-cyber-green light:border-green-300 rounded-lg text-cyber-green dark:text-cyber-green light:text-green-700 group-hover:bg-cyber-green group-hover:text-terminal-bg dark:group-hover:text-terminal-bg light:group-hover:text-white transition-all duration-300 text-sm sm:text-base">
          ...
          <div className="relative group">
            ...
            {editingTHM ? (
              // THM Edit Mode
              <div className="bg-card-bg border border-purple-500 rounded-lg p-4 sm:p-6 lg:p-8">
                <div className="flex items-center mb-4 sm:mb-6">
              ...
              <Link href="/machines/thm" className="block group">
                <div className="bg-card-bg border border-purple-500/30 rounded-lg p-4 sm:p-6 lg:p-8 hover:border-purple-500 hover:bg-purple-500/5 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30 hover:scale-[1.02]">
                  <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <div className="text-center">
                    <span className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-purple-500/10 dark:bg-purple-500/10 light:bg-purple-50 border border-purple-500 dark:border-purple-500 light:border-purple-300 rounded-lg text-purple-500 dark:text-purple-400 light:text-purple-700 group-hover:bg-purple-500 group-hover:text-white dark:group-hover:text-white light:group-hover:text-white transition-all duration-300 text-sm sm:text-base">
                      Explore THM Rooms →
                    </span>
                  </div>
                </div>
