...
const Tools = () => {
  ...
  useEffect(() => {
    ...
    filtered.sort((a, b) => {
      switch (sortBy) {
        ...
        case 'oldest':
          const oldDateA = new Date(a.publishedAt || '1970-01-01').getTime();
          const oldDateB = new Date(b.publishedAt || '1970-01-01').getTime();
  ...
  }, [tools, selectedTag, searchTerm, sortBy]);
    ...
    <Layout>
      <div className="py-4 sm:py-6 lg:py-8">
        ...
        {!loading && !error && (
          <>
            {/* Stats Display */}
            <div className="bg-card-bg border border-cyber-purple/30 p-3 sm:p-4 lg:p-6 rounded-lg mb-4 sm:mb-6 mx-2 sm:mx-0">
            ...
            <div className="bg-card-bg border border-cyber-green/30 p-4 sm:p-6 rounded-lg mb-6 sm:mb-8 mx-2 sm:mx-0">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div className="relative sm:col-span-2 lg:col-span-1">
                  <input
                    ...
                    className="w-full bg-terminal-bg border border-cyber-green/50 pl-3 sm:pl-4 pr-3 sm:pr-4 py-2 rounded text-cyber-green focus:border-cyber-green focus:outline-none text-sm sm:text-base"
                  />
                </div>
                ...
                <select
                  ...
                  className="bg-terminal-bg border border-cyber-green/50 px-3 sm:px-4 py-2 rounded text-cyber-green focus:border-cyber-green focus:outline-none [&>option]:text-foreground [&>option]:bg-card-bg text-sm sm:text-base"
                >
                ...
                <select
                  ...
                  className="bg-terminal-bg border border-cyber-blue/50 px-3 sm:px-4 py-2 rounded text-cyber-blue focus:border-cyber-blue focus:outline-none [&>option]:text-foreground [&>option]:bg-card-bg text-sm sm:text-base"
                >
                ...
                <button
                  ...
                  className="bg-cyber-green text-white px-3 sm:px-4 py-2 rounded font-bold hover:bg-cyber-blue transition-colors text-sm sm:text-base"
                >
                  Clear Filters
                </button>
              </div>
            ...
            {/* Action Buttons */}
            <div className="bg-card-bg border border-cyber-blue/30 p-3 sm:p-4 rounded-lg mb-6 sm:mb-8 mx-2 sm:mx-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 px-2 sm:px-0">
              {filteredTools.map((tool, index) => (
                <div
                  key={tool.id}
                  className="bg-card-bg border border-cyber-green/30 rounded-lg p-4 sm:p-6 hover:border-cyber-green transition-all duration-300 group animate-fade-in"
